...
const roots = '#mt-root,#mt-command-palette,.mt-workspace-chrome,#nt-chat-toolbar,#nt-chat-history,#nt-variable-manager,#nt-variable-manager-quick-button,#nt-world-info-info,#nt-world-info-info-button,#nt-timeline-panel,#nt-timeline-button,#nt-context-inspector,#nt-context-inspector-button,#nt-chat-tools,#nt-chat-tools-button,#nt-calendar-manager,#nt-calendar-button,#nt-preferences,#nt-chat-appearance-modal,#nt-health-panel,#nt-about-panel,#nt-home-dashboard,#nt-community-panel,#nt-persona-workspace,#nt-lorebook-workspace,#nt-character-workspace,#nt-background-workspace';
